  ...
  <div class="container mx-auto px-6 py-20 max-w-4xl">
    ...
    <div class="space-y-12 text-slate-300 leading-relaxed">
      ...
      <section>
        ...
        <p>CheatHaram ("we", "us", or "our") is committed to protecting your privacy. This Privacy Policy explains what data we collect, how we use it, and your rights regarding that data when you use our anti-cheat software.</p>
      </section>
      ...
      <section>
        ...
        <div class="h-px bg-white/5 mb-6"></div>
        <p>Data is retained for as long as necessary to fulfill the purposes described above. Screenshots are stored for up to 90 days unless flagged for investigation, in which case they may be retained longer.</p>
      </section>

      <section>
        <h2 class="text-2xl font-bold text-white mb-4">5. Data Sharing</h2>
        <div class="h-px bg-white/5 mb-6"></div>
        <p>We do not sell or share your personal data with third parties. Data may be shared with authorized server administrators within the CheatHaram network strictly for moderation purposes.</p>
      </section>
      ...
      <div class="p-8 bg-slate-800/30 border border-white/5 rounded-3xl">
        <p class="text-slate-400">For privacy inquiries, please reach out to the CheatHaram team via the <a href="https://discord.gg/fPwZNBskNK" target="_blank" class="text-amber-500 hover:text-amber-400 font-semibold transition-colors underline underline-offset-4">official Discord server</a>.</p>
      </div>
    </div>
  </div>
</template>
